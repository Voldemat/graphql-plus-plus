...
export type FragmentSpecSchemaZodType = z.ZodDiscriminatedUnion<
    [ObjectFragmentSpec, UnionFragmentSpec]
>;
...
export const fieldSelection = z.object({
...
export const unionSelection: UnionSelectionZodType = z.lazy(() =>
...
export const objectSelection = z.lazy(() =>
    z.discriminatedUnion('_type', [
        fieldSelection,
        typenameSelection,
        spreadSelection,
...
export const objectFragmentSpec: ObjectFragmentSpec = z.object({
