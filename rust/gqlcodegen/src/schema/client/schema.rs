            ...
            r##"
{
  "fragments": {
    "Deal": {
      "sourceText": "fragment Deal on Deal { projectManager { ...SmallTag } projectLead { ...SmallTag } site { ...SmallTag } stage { ...SmallTag } architect { ...SmallTag } area { ...SmallTag } archive { ...SmallTag } place { ...SmallTag } qualification { ...SmallTag } mathArea { ...SmallTag } diameter { ...SmallTag }}",
      "spec": {
    ...
    "File": {
      "sourceText": "fragment File on File { id filename mimeType previewUrl createdAt sizeInBytes user { name }}",
      "spec": {
        "_type": "ObjectFragmentSpec",
        "name": "File",
        "selections": [
    ...
    "IntObject": {
      "sourceText": "fragment IntObject on IntObject { value}",
      "spec": {
        "_type": "ObjectFragmentSpec",
        "name": "IntObject",
        "selections": [
    ...
    "SmallTag": {
      "sourceText": "fragment SmallTag on Tag { id tag}",
      "spec": {
        "_type": "ObjectFragmentSpec",
        "name": "Tag",
        "selections": [
    ...
    "Tag": {
      "sourceText": "fragment Tag on Tag { id tag isFavourite hasChildren isApproved}",
      "spec": {
        "_type": "ObjectFragmentSpec",
        "name": "Tag",
        "selections": [
  ...
  "operations": {
    "AddTagToCatalog": {
      ...
      "sourceText": "mutation AddTagToCatalog($tagId: UUID!) { error: addTagToCatalog(tagId: $tagId) { __typename }}",
      "hash": "11118800150692197624"
    },
    "AddTagsToFiles": {
      "name": "AddTagsToFiles",
      "type": "MUTATION",
    ...
    "GetDealInfo": {
      ...
      "sourceText": "query GetDealInfo($id: UUID!){ info: getDealInfo(id: $id) { ...Deal }}",
      "hash": "1428949861843738232"
    },
    "GetDeals": {
      "name": "GetDeals",
      "type": "QUERY",
      ...
      "sourceText": "query GetDeals($skip: Int!, $limit: Int!, $query: String){ deals: getDeals(skip: $skip, limit: $limit, query: $query) { ...SmallTag }}",
      "hash": "9416407972019189485"
    },
    "GetEvents": {
      "name": "GetEvents",
      "type": "QUERY",
    ...
    "GetFileURL": {
      ...
      "sourceText": "query GetFileURL($id: UUID!) { url: getFileURL(id: $id) { __typename ... on UrlObject { value } }}",
      "hash": "3618559389732264511"
    },
    "GetFiles": {
      "name": "GetFiles",
      "type": "QUERY",
      ...
      "sourceText": "query GetFiles( $skip: Int!, $limit: Int!, $tagIds: [UUID!]!, $sortBy: FileSortBy) { data: getFiles( skip: $skip, limit: $limit, tagIds: $tagIds, sortBy: $sortBy ) { __typename ... on ErrorUnknownTags { ...ErrorUnknownTags } ... on SearchFileList { ...SearchFileList } }}",
      "hash": "11784545539341565672"
    },
    "GetFilesCount": {
      "name": "GetFilesCount",
      "type": "QUERY",
      ...
      "sourceText": "query GetFilesCount($tagIds: [UUID!]!) { count: getFilesCount(tagIds: $tagIds) { __typename ... on ErrorUnknownTags { ...ErrorUnknownTags } ... on IntObject { ...IntObject } }}",
      "hash": "671336904096262462"
    },
    "GetGroupTags": {
      "name": "GetGroupTags",
      "type": "QUERY",
    ...
    "GetGroupUsersTotal": {
      ...
      "sourceText": "query GetGroupUsersTotal($groupId: UUID!) { total: getGroupUsersTotal(groupId: $groupId) { __typename ... on IntObject { value } }}",
      "hash": "9225210424499568333"
    },
    "GetGroups": {
      "name": "GetGroups",
      "type": "QUERY",
    ...
    "GetPendingUsers": {
      ...
      "sourceText": "query GetPendingUsers { getPendingUsers { users { ...PendingUser } }}",
      "hash": "6870026420132680667"
    },
    "GetPopularTags": {
      "name": "GetPopularTags",
      "type": "QUERY",
    ...
    "GetTagsCount": {
      ...
      "sourceText": "query GetTagsCount($parentTag: String, $query: String) { data: getTagsCount( parentTag: $parentTag, query: $query ) { __typename ... on IntObject { value } ... on ErrorUnknownTags { ...ErrorUnknownTags } }}",
      "hash": "9203785367935208008"
    },
    "GetTimestampOfLatestDeal": {
      "name": "GetTimestampOfLatestDeal",
      "type": "QUERY",
      "parameters": {},
      "fragmentSpec": {
        "_type": "ObjectFragmentSpec",
        ...
        "selections": [
          {
            "_type": "FieldSelection",
            "name": "getTimestampOfLatestDeal",
            "alias": "getTimestampOfLatestDeal",
            "arguments": {},
            "selection": null
          }
        ]
      },
      "sourceText": "query GetTimestampOfLatestDeal { getTimestampOfLatestDeal}",
      "hash": "17939989561600861895"
    },
    "GetUploadedFiles": {
      ...
      "sourceText": "query GetUploadedFiles( $skip: Int!, $limit: Int!, $sortBy: FileSortBy) { data: getUploadedFiles( skip: $skip, limit: $limit, sortBy: $sortBy ) { __typename ... on ErrorUnknownTags { ...ErrorUnknownTags } ... on SearchFileList { ...SearchFileList } }}",
      "hash": "6991220225272933069"
    },
    "GetUploadedFilesCount": {
      ...
      "sourceText": "query GetUploadedFilesCount { count: getUploadedFilesCount { __typename ... on ErrorUnknownTags { ...ErrorUnknownTags } ... on IntObject { ...IntObject } }}",
      "hash": "3030892249575758739"
    },
    "GetUsers": {
      "name": "GetUsers",
      "type": "QUERY",
      ...
      "sourceText": "query GetUsers( $skip: Int!, $limit: Int!, $sortBy: GetUsersSortBy!, $query: String) { users: getUsers( skip: $skip, limit: $limit, sortBy: $sortBy, query: $query ) { ...UsersList }}",
      "hash": "14379953529622046072"
    },
    "GetUsersTags": {
      "name": "GetUsersTags",
      "type": "QUERY",
    ...
    "GetUsersTagsAndCount": {
      ...
      "sourceText": "query GetUsersTagsAndCount( $skip: Int!, $limit: Int!, $query: String) { tags: getUsersTags( skip: $skip, limit: $limit, query: $query ) { ...UsersTag } count: getUsersTagsCount(query: $query)}",
      "hash": "7493139076191002845"
    },
    "GetUsersTagsCount": {
      "name": "GetUsersTagsCount",
      "type": "QUERY",
    ...
    "GetUsersTotalAndUsers": {
      ...
      "sourceText": "query GetUsersTotalAndUsers( $skip: Int!, $limit: Int!, $sortBy: GetUsersSortBy!, $query: String) { total: getUsersTotal(query: $query) users: getUsers( skip: $skip, limit: $limit, sortBy: $sortBy, query: $query ) { ...UsersList }}",
      "hash": "14951699237626581254"
    },
    "IsAllowedToDownload": {
      ...
      "sourceText": "query IsAllowedToDownload($id: UUID!) { allowed: isAllowedToDownload(id: $id) { __typename ... on BooleanObject { value } }}",
      "hash": "10298951714648703422"
    },
    "IsTagExists": {
      "name": "IsTagExists",
      "type": "QUERY",
    ...
    "UpdateFile": {
      ...
      "hash": "6188777152924283913"
    },
    "UploadDealTable": {
      "name": "UploadDealTable",
      "type": "MUTATION",
      "parameters": {
        "$file": {
          "nullable": false,
      ...
      "sourceText": "mutation UploadDealTable($file: Upload!) { error: uploadDealTable(file: $file) { message }}",
      "hash": "2856131315236178725"
    }
  },
  "directives": {}
}
